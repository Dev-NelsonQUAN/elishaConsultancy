...
import forgotImg from "../assets/ESCConfirmPassword.png"
                    ...
                    <form className='p-[30px] mt-25'>
                        <div className=''>
                            ...
                            <input
                                ...
                                type="text" placeholder='Create a new password' />
                            <input
                                className='w-[100%] border-1 border-gray-700 rounded-[5px] px-4 py-3 outline-none mt-10'
